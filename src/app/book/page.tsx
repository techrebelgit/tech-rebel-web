...
export default function BookPage() {
  ...
  // For demo purposes, we'll assume any connected wallet has the NFT
  const hasRequiredNFT = walletAddress !== null
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <div className="bg-rebel-light p-6 rounded-xl border border-rebel-gray shadow-sm sticky top-24">
                ...
                <Button variant="outline" className="w-full" onClick={() => setWalletAddress(null)}>
                  Disconnect Wallet
                </Button>
              </div>
            </div>
