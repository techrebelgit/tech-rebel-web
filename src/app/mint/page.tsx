...
export default function MintPage() {
  const contractAddress = process.env.NEXT_PUBLIC_TECH_REBEL_NFT_CONTRACT!;
          ...
          <div className="space-y-8">
            <div className="bg-rebel-light p-6 rounded-xl border border-rebel-gray shadow-sm">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Each NFT gives you access to a 1:1 strategy and product
                  feedback session with Tech Rebel
                </li>
                <li>
                  Get personalized insights to improve your Web3 product or
                  startup
                </li>
                <li>
                  Priority consideration for grants, collaborations, and
                  community exposure
                </li>
                <li>
                  Sessions are redeemable via the <strong>Book</strong> section
                  after wallet verification
                </li>
                <li>
                  Each token is unique and mapped — no duplicate redemptions
                </li>
              </ul>
            </div>
            ...
            <div className="bg-rebel-light p-6 rounded-xl border border-rebel-gray shadow-sm">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>
                  Make sure you have some ETH on the <strong>Base</strong>{' '}
                  network
                </li>
                ...
                <li>
                  Head over to the <strong>Book</strong> section to redeem your
                  session
                </li>
              </ol>
            </div>
